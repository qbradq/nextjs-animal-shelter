        ...
        <>
            ...
            {pets.map((pet: Pet) => (
                <Link key={pet.uuid} href={"/pets/" + pet.uuid}>
                    <div key={pet.uuid} className="w-fit border-black border-2 rounded-sm m-2">
                        <div className="text-2xl font-bold text-center bg-blue-300 border-black border-b-2">{pet.name}</div>
